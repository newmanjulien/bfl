<script lang="ts">
	...
	import type { TimelineItem } from '$lib/presentation/models';
	import AppAvatar from '$lib/ui/skeleton/AppAvatar.svelte';
		...
		>
			...
			>
				{#if item.marker.kind === 'avatar'}
					<AppAvatar person={item.marker.person} size={TIMELINE_LAYOUT.avatarSize} />
				{:else}
					<span
						aria-hidden="true"
